...
🚀 Skilled in **Java, Python, and MERN Stack**  


## 🔹 About Me  
✨ CS undergraduate with hands-on experience in **Java applications and full-stack development**  
💡 Internship experience in **MERN stack** & **Java programming**  
📘 Built projects like **Student Management System (Java + Oracle DB)**  
🌱 Always improving through open-source contributions and new tech exploration  
...
⚙️ Tech: Java, Oracle DB, File Handling  
📂 Features: Add, update, search & delete student data  



### 🌐 [MERN Stack Applications](https://github.com/debugwithsushant)  
💡 Full-stack web apps built during internship.  
⚙️ Tech: MongoDB, Express.js, React, Node.js  
🚀 Focused on CRUD, authentication & REST APIs  
